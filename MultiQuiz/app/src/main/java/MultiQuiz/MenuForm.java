...
import javax.swing.JOptionPane;
 ...
 // By Numan
 // Class that generates main menu jframe
public class MenuForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        titleLabel.setFont(new java.awt.Font("Segoe UI Black", 1, 36)); // NOI18N
        titleLabel.setText("Multi-Quiz");

        userTxtField.setText("Enter window's username");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if(usernameEntered == true){
            QuizStart qzForm = new QuizStart();
            qzForm.setVisible(true);
        }
    ...
    //Stores user's input as variable, transfers to static variable for public/global access
    private void submitUserActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitUserActionPerformed
       if(userTxtField.getText().equals("")){
           JOptionPane.showMessageDialog(null, "Enter your window's username, please.", "ERROR", JOptionPane.WARNING_MESSAGE);
       }
       else{
           
           tempUsername = userTxtField.getText();
           UserInput.DataStorage.usernameDisplay = tempUsername;
